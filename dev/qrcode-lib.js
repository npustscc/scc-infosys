// dev/qrcode-lib.js — v264 拆 index.html 第十八刀：手刻 QR code 編碼器（QRCodeGen，Kazuhiko Arase
// qrcode-generator MIT 移植，詳見下方原始檔頭註解）。inline script 區塊原地外部化，執行時機不變；
// 由 build-public.js 原樣複製並納入 buildId 雜湊。
