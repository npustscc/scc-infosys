...
const TC_HINTS = [
  ...
  { id: 4,  icon: 'autosave',   title: '表單自動備援',    desc: '長表單每 5 秒自動備份到瀏覽器，當機或誤關後登入會提示復原。',
    tw: { t: '表單自動備份', d: '長表單逐 5 秒自動備份佇瀏覽器，當機抑是毋細膩關掉，閣登入的時會提醒你復原。' },
    hk: { t: '表單自動備份', d: '長表單逐 5 秒自動備份在瀏覽器，當機抑係毋小心關掉，再登入時會提醒你復原。' },
    en: { t: 'Auto form backup', d: 'Long forms auto-save to your browser every 5 seconds; after a crash or accidental close, you\'ll be prompted to restore on login.' } },
